...
var 第四关经验 = 20000000;
//设置问题
var questions = Array("请问法师一转要多少等级（答案8）",
        "请问飞侠一转要多少等级（答案10）",
        "请问法师转职需要多少智力（答案20）",
        "请问弓箭手转职需要多少敏捷（答案25）",
        "请问多少级才能进行二转（答案30）",
...
var stage4combos = Array(Array(1, 1, 1, 0, 0, 0));
var eye = 9300002;
var necki = 9300000;
var slime = 9300003;
                ...
                if (complete != null) {
                    ...
                    if (totplayers > 0 || debug) {
                        ...
                        if (testcombo || debug) {
                            ...
                            //给予团队经验
                            if (nthtext == 2) {
                                cm.givePartyExp(第二关经验, party);
                            } else if (nthtext == 3) {
                                cm.givePartyExp(第三关经验, party);
                            } else if (nthtext == 4) {
                                cm.givePartyExp(第四关经验, party);
                            }
