...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t\t  #e#r #v4000005#  枫叶戒指  #v4000005##k#n              \r\n"
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d剩余金币：#b" + cm.getMeso() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r" + 蓝色角点 + "枫叶戒指1阶段 20六维#r New     #v1112670##l#l\r\n\r\n"//3
            text += "#L2##r" + 蓝色角点 + "枫叶戒指2阶段 40六维#r New     #v1112671##l#l\r\n\r\n"//3
            text += "#L3##r" + 蓝色角点 + "枫叶戒指3阶段 80六维#r New     #v1112672##l#l\r\n\r\n"//3
            text += "#L4##r" + 蓝色角点 + "枫叶戒指4阶段 120六维#r New     #v1112673##l#l\r\n\r\n"//3
