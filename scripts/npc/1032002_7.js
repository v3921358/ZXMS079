...
function action(mode, type, selection) {
    ...
    if (selection == 0) {
        var txt1 = '#r#e调试洗掉的抚摸位置，如果选错将会不可逆。#k#n\r\n';
        var txt2 = '';
        var inv = cm.getInventory(-1);
        txt2 += "#d调试清洗位置； 当前精确清洗 #r" + cm.getPlayer().清洗() + "#k 孔#k\r\n";
        txt2 += " #L1##b加孔位#l #L2#减孔位#l#k\r\n\r\n";
        txt2 += "#d清洗所需材料；#k\r\n";
...
function 清洗(x) {
    ...
    cm.收点券(点券);
    if (cm.百分率(清洗成功率)) {
        cm.清洗身上装备附魔(x, cm.getPlayer().清洗孔());
