...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t#e#r #v4000422#  累计充值礼包中心  #v4000422##k#n              \r\n#b#e\t发购买记录截图 联系群主QQ：554548946#b#k\r\n\t\t\t#n#r附带你的游戏角色名\r\n"
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d剩余金币：#b" + cm.getMeso() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
          //  text += "#L6##r" + 蓝色角点 + " #r New 注：《购买GM #k可刷物品获得 #r礼包！》 #l\r\n"//3
            text += "#L1##r" + 蓝色角点 + " 赞助中心#r New  #v3994691# #l\r\n\r\n"//3
            text += "#L2##r" + 蓝色角点 + " 独有宠物兑换#r New  #v5000474# #l\r\n\r\n"//3
          //  text += "#L121##b" + 蓝色角点 + "#r 赞助说明：#b你购买了300礼包就可以领取300 100 \r\n#k你购买了1000 就可以领取 1000 500 300 100\r\n#r 你购买了3000 就可以领取 3000 1000 500 300 100 #l\r\n\r\n"//3
