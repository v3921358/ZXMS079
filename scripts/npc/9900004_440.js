...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t\t  #e#r #v4000005#  专属戒指  #v4000005##k#n              \r\n"
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d剩余金币：#b" + cm.getMeso() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1111##b#e  #v1112540#  小青蛇戒指I  在主线任务获得！ #v1112540##l#l\r\n\r\n"//3
            text += "#L2##r" + 蓝色角点 + "小青蛇戒指升级为专属戒指 #r New     #v1113096##l#l\r\n\r\n"//3
...
text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
        ...
        } else if (selection == 1111) {//神话耳环1
            cm.openNpc(9900004, 506);
        } else if (selection == 2) {//疾风戒指2
            cm.openNpc(9900004, 963);
        } else if (selection == 3) {//疾风戒指3
            cm.openNpc(9900004, 964);
        } else if (selection == 4) {//疾风戒指4
            cm.openNpc(9900004, 965);
