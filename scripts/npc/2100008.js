...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += "哈哈，我就是本服的觉醒商人八德乐，我有复古的觉醒方法可以帮助你把#v1002357##r★扎昆头盔★#k完成一次#b神级觉醒#k\r\n需要以下物品：（已经完成过神级觉醒的扎头无效！）\r\n#v1002357# * 1个\r\n#v4440000##d#z4440000# * 1个\r\n#v4441000##d#z4441000# * 1个\r\n#v4442000##d#z4442000# * 1个\r\n#v4310022##d#z4310022# * 200个\r\n#v4443000##d#z4443000# * 1个\r\n#v2140002##d金币 * 1亿\r\n~\r\n"
	text += "\r\n#L1##b我收集了以上物品。确定开始觉醒装备";
	text += "     \r\n"
        cm.sendSimple(text);
        } else if (selection == 1) {
                      if(cm.haveItem(4310022,200) && cm.haveItem(4440000,1) && cm.haveItem(4441000,1) && cm.haveItem(4442000,1)  && cm.haveItem(4443000,1) && cm.haveItem(1002357,1)){
             ...
             cm.给属性装备(1002357, 10, 6, 60, 60, 60, 60, 200, 200, 60, 60,60, 60, 60, 60, 60, 60, 0);
