...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        switch (selection) {
			...
			case 1:
				if(cm.判断物品数量(2022028,100)&&cm.判断物品数量(2022029,100)&&cm.判断物品数量(2022030,100)){
				   cm.收物品(2022028,100);
				   cm.收物品(2022029,100);
				   cm.收物品(2022030,100);
				   cm.给物品(3012011,1);
				   ...
				   cm.说明文字("兑换 "+cm.显示物品(3012011)+" 需要 \r\n\r\n"+cm.显示物品(2022028)+" x 100\r\n"+cm.显示物品(2022029)+" x 100\r\n"+cm.显示物品(2022030)+" x 100");
				}
                cm.对话结束();
                break;
        }
