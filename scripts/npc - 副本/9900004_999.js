...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += " \t\t#e#r #v4310015#  副本奖励兑换中心  #v4310015##k#n\r\n #b获得处#k: 废弃都市 - 组队任务\r\n"
...
text += "#L2##k" + 爱心 + " #v1302086##b重生装备自选  #k需要#v4310113##kx#r#e 288#n#k  #v4310022##kx#r#e 99#n#k#l\r\n"//3

           text += "#L3##k" + 爱心 + " #v1302081##b永恒装备抽奖  #k需要#v4310113##kx#r#e 288#n#k  #v4310022##kx#r#e 99#n#k#l\r\n"//3
 ...
 if (cm.getPlayer().isGM()) {
		...
		//cm.gainItem(5222000, -1);
           ...
           cm.sendOk("你没有足够物品，无法抽奖！#k需要#v4310113##kx#r#e 288#n#k  #v4310022##kx#r#e 99#n#k 个");
            cm.dispose();
}
