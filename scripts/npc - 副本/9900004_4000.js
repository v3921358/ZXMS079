...
function action(mode, type, selection) {
    if (mode == -1) {
      ...
      text += "#L919##r" + 蓝色角点 + " #r 首冲任意50元以上送红武《任选》！ New  #v1402214##l#l\r\n"//3

            text += "#L1##r" + 蓝色角点 + " 累计充值~~ 100元礼包#r New     #v4000423##l \r\n"//3

            text += "#L2##r" + 蓝色角点 + "#r 累计充值~~ 300元礼包 #rNew     #v4000424##l \r\n"//3

            text += "#L3##r" + 蓝色角点 + "#r 累计充值~~ 500元礼包#rNew     #v4000425##l#l \r\n"//3

            text += "#L4##r" + 蓝色角点 + "#r 累计充值~~ 1000元礼包#r New     #v4031505##l#l \r\n"//3

            text += "#L5##r" + 蓝色角点 + "#r 累计充值~~ 3000元礼包#r New     #v4031506##l \r\n\r\n\r\n"//3
