...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t\t  #e#r #v4000005#  神话耳环  #v4000005##k#n              \r\n"
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d剩余金币：#b" + cm.getMeso() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r" + 蓝色角点 + "神话耳环升级1阶段 #r New     #v1032206##l#l\r\n\r\n"//3
            text += "#L2##r" + 蓝色角点 + "神话耳环升级2阶段 #r New     #v1032207##l#l\r\n\r\n"//3
            text += "#L3##r" + 蓝色角点 + "神话耳环升级3阶段 #r New     #v1032208##l#l\r\n\r\n"//3
            text += "#L4##r" + 蓝色角点 + "神话耳环升级4阶段 #r New     #v1032209##l#l\r\n\r\n"//3
            text += "#L5##r" + 蓝色角点 + "遗忘之神话耳环 #r New     #v1032219##l#l\r\n\r\n"//3
...
text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
		    ...
		    cm.sendSimple(text);
        } else if (selection == 1) {//神话耳环1
            cm.openNpc(9900004, 1800);
        } else if (selection == 2) {//神话耳环2
            cm.openNpc(9900004, 1801);
        } else if (selection == 3) {//神话耳环3
            cm.openNpc(9900004, 1802);
        } else if (selection == 4) {//神话耳环4
            cm.openNpc(9900004, 1803);
        } else if (selection == 5) { //神话耳环5
            cm.openNpc(9900004, 1804);
