    ...
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
           // text += "#L72##r" + 蓝色角点 + "材料合成#r New     #v4251202##z4251202##l#l\r\n\r\n"//3
            text += "#L71##r" + 蓝色角点 + "血衣制作#r New     #v1012176##z1012176##l#l\r\n\r\n"//3
            text += "#L73##r" + 蓝色角点 + "小青蛇戒指升级#r New     #v1112540# 超然属性#l#l\r\n\r\n"//3
            text += "#L9##r" + 蓝色角点 + "神话耳环升级 #r New     #v1032219##z1032219##l#l\r\n\r\n"//3
            text += "#L1##r" + 蓝色角点 + "儿时枫叶 ~~ 武器#r New     #v1302030##z1302030##l#l\r\n\r\n"//3
            //text += "#L8##r" + 蓝色角点 + " 铂金~~ 套装#r New     #v1052358##z1052358##l#l\r\n\r\n"//3
            text += "#L2##r" + 蓝色角点 + "#r 皇家班 ~~ 武器#r New     #v1402237##z1402237##l#l\r\n\r\n"//3
            text += "#L3##r" + 蓝色角点 + "#r 巨匠 ~~ 套#r New     #v1412144##z1412144##l#l\r\n\r\n"//3
           text += "#L4##r" + 蓝色角点 + "#r 法弗纳 ~~ 套#r New     #v1332225##z1332225#     #v1042254##z1042254##l#l\r\n\r\n"//3
...
text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
		    ...
		    cm.sendSimple(text);
        } else if (selection == 71) {//血衣制作
            cm.openNpc(2100007, 1);
