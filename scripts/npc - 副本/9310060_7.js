...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "	  Hi~#b#h ##k我是星缘，你如果能给我足够多我想要的，我就给你兑换不一样的道具哦。\r\n";
        ...
        switch (selection) {
			case 5:
				if(cm.判断物品数量(3994046,30)){
				   cm.收物品(3994046,30);
				   cm.给物品(2340000,1);
				   cm.个人存档();
				   cm.说明文字("恭喜你成功兑换 "+cm.显示物品(2340000)+"");
				}else{
				   cm.说明文字("兑换 "+cm.显示物品(2340000)+" 需要 "+cm.显示物品(3994046)+" x 30");
				}
                cm.对话结束();
                break;
			case 4:
				if(cm.判断物品数量(3994046,10)){
				   ...
				   cm.说明文字("兑换 "+cm.显示物品(2370000)+" 需要 "+cm.显示物品(3994046)+" x 10");
				}
                cm.对话结束();
                break;
			case 3:
				if(cm.判断物品数量(3994046,50)){
				   ...
				   cm.说明文字("兑换 "+cm.显示物品(2101118)+" 需要 "+cm.显示物品(3994046)+" x 50");
				}
                cm.对话结束();
                break;
			case 1:
				if(cm.判断物品数量(3994046,100)){
				   ...
				   cm.说明文字("兑换 "+cm.显示物品(3010037)+" 需要 "+cm.显示物品(3994046)+" x 100");
				}
                cm.对话结束();
                break;
			case 2:
				if(cm.判断物品数量(3994046,10)){
				   ...
				   cm.说明文字("兑换 "+cm.显示物品(4032226)+" 需要 "+cm.显示物品(3994046)+" x 10");
				}
                cm.对话结束();
                break;
