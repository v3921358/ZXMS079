...
function start() {
	...
	cm.充值卡兑换记录("群聊奖励",""+cm.getChar().getName()+" 使用了群聊奖励，"+r+"");
    switch (r) {
		case 0:
			var r1 = Math.ceil(Math.random() * 200);
			if(r1==99){
        ...
        case 1:
            var 数量 = cm.随机数(5);
            cm.给物品(4280000, 数量);
            cm.说明文字("恭喜你获得了 " + cm.显示物品(4280000) + " x " + 数量 + "");
			cm.对话结束();
            break;
        case 2:
            var 数量 = cm.随机数(5);
            cm.给物品(4280001, 数量);
            cm.说明文字("恭喜你获得了 " + cm.显示物品(4280001) + " x " + 数量 + "");
			cm.对话结束();
            break;
        case 3:
            var 数量1 = cm.随机数(2);
            ...
            cm.给物品(4280000, 数量1);
            cm.给物品(4280001, 数量2);
            cm.说明文字("恭喜你获得了 " + cm.显示物品(4280000) + " x " + 数量1 + " " + cm.显示物品(4280001) + " x " + 数量2 + "");
			cm.对话结束();
            break;
		case 4:
			var 数量 = cm.随机数(500000);
            cm.给金币(数量);
            cm.说明文字("恭喜你获得了 #b" + 数量 + "#k 金币。");
			cm.对话结束();
            break;	
		case 5:
            var 数量 = cm.随机数(100000);
            cm.给经验(数量);
            cm.说明文字("恭喜你获得了 #b" + 数量 + "#k 经验。");
			cm.对话结束();
            break;		
		case 6:
		case 7:
...
function action(mode, type, selection) {
	...
	if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            item = cm.gainGachaponItem(itemId, quantity, "群聊奖励", notice);
            if (item != -1) {
