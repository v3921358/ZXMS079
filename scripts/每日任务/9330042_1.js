...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.getBossLog("活跃度1") <= 0) {
            selStr += "\t\t#L1##b领取 #r10#b 活跃度奖励 #r2000W#b 金币#l\r\n";
        }else{
			selStr += "\r\n\t\t   #b领取 #r10#b 活跃度奖励 #r2000W#b 金币#k[#d完成#k]\r\n";
		}
        ...
        if (cm.getBossLog("活跃度4") <= 0) {
            selStr += "\t\t#L4##b领取 #r40#b 活跃度奖励 #r30 #b#z4000463##l\r\n";
        }else{
			selStr += "\t\t   #b领取 #r40#b 活跃度奖励 #r30 #b#z4000463##k[#d完成#k]\r\n";
		}
		
        if (cm.getBossLog("活跃度5") <= 0) {
            selStr += "\t\t#L5##b领取 #r50#b 活跃度奖励 #r50 #b#z4000463##l\r\n";
        }else{
			selStr += "\t\t   #b领取 #r50#b 活跃度奖励 #r50 #b#z4000463##k[#d完成#k]\r\n";
		}
		
        if (cm.getBossLog("活跃度6") <= 0) {
            selStr += "\t\t#L6##b领取 #r65#b 活跃度奖励 #r防暴卡 #bx 2#l\r\n";
        }else{
			selStr += "\t\t   #b领取 #r65#b 活跃度奖励 #r防暴卡 #bx 2#k[#d完成#k]\r\n";
		}
